########## Part 3.5: Organoids species mixing - off target effect analysis ##########
#This part investigates off target effects by matching the cell type annotation with well information of species 
