...
WD="/mnt/khandler/R_projects/Sphere-sequencing/Sphere-seq_analysis/CellPhoneDB/Mets_distance"
CELLPHONE_DIR="/mnt/khandler/R_projects/Sphere-sequencing/Sphere-seq_analysis/CellPhoneDB/Mets_distance"
