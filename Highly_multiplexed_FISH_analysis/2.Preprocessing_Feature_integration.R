...
###remove cells with lower than 0 counts and molecules detected, 
#some cell types only express low amount of genes from gene panel therefore only a >0 cutoff is applied 
