...
DGE_between_veins_hmFISH(veins, "annotation","LECs","vein", "./data_files_generated/") 
top <- read.csv("./data_files_generated/vein_LECs_DGE_hmFISH.csv")
...
p <- ggplot(top, aes(x=logFC, y=-log10(PValue))) +
  ...
  xlab("logFC") + 
  ylab("-log10(PValue)") + ggtitle("LECs - Resolve (PValue ≤ 0.05, logFC >0.5") + 
...
boxplot_LECs_per_spatial_area(veins,"Lhx6","red","./figures/4.1/",".pdf")
boxplot_LECs_per_spatial_area(veins,"Plpp1","red","./figures/4.1/",".svg")
boxplot_LECs_per_spatial_area(veins,"Lhx6","red","./figures/4.1/",".svg")

#PV zonated 
boxplot_LECs_per_spatial_area(veins,"Cd36","darkgoldenrod2","./figures/4.1/",".pdf")
boxplot_LECs_per_spatial_area(veins,"Galnt15","darkgoldenrod2","./figures/4.1/",".pdf")
boxplot_LECs_per_spatial_area(veins,"Cd36","darkgoldenrod2","./figures/4.1/",".svg")
boxplot_LECs_per_spatial_area(veins,"Galnt15","darkgoldenrod2","./figures/4.1/",".svg")


########## Kupffer cells ##########
###DGE analysis and vulcano plotting 
DGE_between_veins_hmFISH(veins, "annotation","Kupffer","vein", "./data_files_generated/") 
