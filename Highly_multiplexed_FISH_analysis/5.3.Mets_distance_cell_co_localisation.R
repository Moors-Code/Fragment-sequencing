...
#This part does cell co-localisation analysis comparing proximal and distal areas 
...
###Now this is reduced to only the proximal area and contains a column with the difference with regards to the distal area
...
ggsave("./figures/5.3/Contacts_Mets.pdf",width = 12, height = 10)
ggsave("./figures/5.3/Contacts_Mets.svg",width = 12, height = 10)
